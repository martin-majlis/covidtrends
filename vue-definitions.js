  ...
  methods: {
    ...
    setxrange() {
      ...
      if (this.scale == 'Logarithmic Scale') {
        ...
        this.xrange = [-0.05*Math.pow(10,Math.floor(Math.log10(xmax))), Math.round(1.05 * xmax)];
      }
    ...
    setyrange() {
      ...
      if (this.scale == 'Logarithmic Scale') {
        ...
        // this.yrange = [0, Math.round(1.05 * ymax)];
      }
...
let app = new Vue({
  ...
  methods: {
    ...
    pullData(selectedData) {
      ...
      } else if (selectedData == 'Svět (úmrtí)') {
      ...
      // adjust min numbers
      if (selectedData.includes('potvrzené')) {
        this.minCasesInCountry = 20;
      } else {
        this.minCasesInCountry = 2  ;
      }
    },
  ...
  data: {
    ...
    dataTypes: [
      ...
      'Svět (úmrtí)',
      'Česko - kraje (úmrtí)',
      'Česko - kraje + Svět (úmrtí)',
      'Česko - věk (úmrtí)',
      'Česko - věk + Svět (úmrtí)',
      'Česko - pohlaví (úmrtí)',
      'Česko - pohlaví + Svět (úmrtí)',
      'Česko - pohlaví a věk (úmrtí)',
      'Česko - pohlaví a věk + Svět (úmrtí)',
    ],
